...
<template>
  ...
  <fieldset class="govuk-fieldset">
    ...
    <div class="govuk-radios govuk-radios--inline">
      <div class="govuk-radios__item">
        <input class="govuk-radios__input" type="radio" :value="0" v-model="form.booleanGivenFamilyName" required
          checked />
        <label class="govuk-label govuk-radios__label" for="m"> Nie </label>
      </div>
      <div class="govuk-radios__item">
        <input class="govuk-radios__input" type="radio" v-model="form.booleanGivenFamilyName" :value="1" required />
        <label class="govuk-label govuk-radios__label" for="w"> Áno </label>
      </div>
    </div>
  </fieldset>

  <div class="govuk-checkboxes__conditional govuk-checkboxes__conditional--hidden" v-if="form.booleanGivenFamilyName">
    <TextField v-model="form.GivenFamilyName" placeholder="Uveďte vaše rodné priezvisko" label="Rodné priezvisko" />

  </div>

  <TextField v-model="form.GivenName" placeholder="Uveďte vaše meno" label="Meno" />
  ...
  <div class="govuk-form-group">
    <fieldset class="govuk-fieldset">
      ...
      <div class="govuk-radios govuk-radios--inline">
        <div class="govuk-radios__item">
          <input class="govuk-radios__input" type="radio" v-model="form.Sex" name="Sex" id="MUZ" value="MUZ" required />
          <label class="govuk-label govuk-radios__label" for="MUZ"> Muž </label>
        </div>
        <div class="govuk-radios__item">
          <input class="govuk-radios__input" type="radio" v-model="form.Sex" name="Sex" id="ZENA" value="ZENA" required />
  ...
  <TextField v-model="form.IdentifierValue" placeholder="Uveďte vaše  rodné číslo" label=" Rodné číslo"
    :input-short="true" />

  <TextField v-model="form.Nationality" placeholder="Uveďte vašu štátnu príslušnosť" label="Štátna príslušnosť"
    :input-short="true" />
  <div class="govuk-form-group">
    <fieldset class="govuk-fieldset">
      ...
      <div class="govuk-radios govuk-radios">
        <div class="govuk-radios__item">
          <input class="govuk-radios__input" type="radio" name="MaritalStatus" v-model="form.MaritalStatus" id="1"
            value="1" required />
        ...
        <div class="govuk-radios__item">
          <input class="govuk-radios__input" type="radio" name="MaritalStatus" v-model="form.MaritalStatus" id="2"
            value="2" required />
        ...
        <div class="govuk-radios__item">
          <input class="govuk-radios__input" type="radio" name="MaritalStatus" v-model="form.MaritalStatus" id="3"
            value="3" required />
        ...
        <div class="govuk-radios__item">
          <input class="govuk-radios__input" type="radio" name="MaritalStatus" v-model="form.MaritalStatus" id="4"
            value="4" required />
        ...
        <div class="govuk-radios__item">
          <input class="govuk-radios__input" type="radio" name="MaritalStatus" v-model="form.MaritalStatus" id="5"
            value="5" required />
