      ...
      <form action="/" @submit.prevent="onSubmit">
        ...
        <div class="govuk-form-group">
          <label
            ...
            for="PropertyRegistrationNumber"
          >
            Súpisné číslo
          </label>
          <span id="input-with-error-message-error" class="govuk-error-message">
        ...
        >
          ...
          <div class="govuk-form-group">
            ...
            <input
              ...
              :class="{
                'govuk-input--error':
                  temporary_PropertyRegistrationNumber == '',
              }"
